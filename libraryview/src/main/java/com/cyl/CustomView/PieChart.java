...
//        setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ...
        this.percentTextSize = array.getDimensionPixelSize(R.styleable.PieChart_textSize, percentTextSize);
        this.name = array.getString(R.styleable.PieChart_name);
        this.percentDecimal = array.getInt(R.styleable.PieChart_percentDecimal, percentDecimal);
